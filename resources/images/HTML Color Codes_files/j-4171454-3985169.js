//Generated:2022-07-13 22:12:17// 39-533
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4171454 || '',
    GUID: window.ftGUID_4171454 || '99999999999',
    confID: window.ftConfID_4171454 || '0',
    ftReturn: window.ftReturn_4171454 || '',
    keyword: window.ftKeyword_4171454 || '',
    ftId: window.ftId_4171454 || '',
    imp: window.ftImp4171454,
    ftImpId: window.ftImp4171454 && window.ftImp4171454.impID || '',
    gdpr: window.ftImp4171454 && window.ftImp4171454.gdpr || '',
    gdpr_consent: window.ftImp4171454 && window.ftImp4171454.gdpr_consent || '',
    gdpr_pd: window.ftImp4171454 && window.ftImp4171454.gdpr_pd || '',
    us_privacy: window.ftImp4171454 && window.ftImp4171454.us_privacy || '',
    campaignID: '115738',
    cID: '155251',
    pID: '4171454',
    creativeID: '3985169',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115738&sid=18330&plc=4171454&num=&adid=&advid=&adsrv=29&btreg=4171454&btadsrv=flashtalking&crt=3985169&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: [
      "https://servedby.flashtalking.com/click/8/115738;4171454;3985169;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/creativecloud/buy/students.html?sdid=CW7624MT&mv=display"
    ],
    placementDescription: 'DV360FY20EDUCTXKWTopicUSDSKBAN300x250',
    width: 300,
    height: 250,
    ...
    divID: 'ftdiv4171454',
    phID: 'ftpos4171454',
    frameID: 'ftframe4171454',
    expID: 'ftexpframe4171454',
    altImgID: 'ftalt4171454',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'https://servedby.flashtalking.com/click/8/115738;4171454;3985169;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/creativecloud/buy/students.html?sdid=CW7624MT&mv=display',
    altImg: 'https://servedby.flashtalking.com/imp/8/115738;4171454;204;gif;DV360;DV360FY20EDUCTXKWTopicUSDSKBAN300x250/?',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115738;4171454;271;pixel;DV360;DV360FY20EDUCTXKWTopicUSDSKBAN300x250/?',
    stump: 'https://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/417/4171454/3985169/js/j-4171454-3985169.js',
    file: 'http://cdn.flashtalking.com/155251/3985169/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?224222742-4171454;3985169;',
    adVis: false ? 1 : 0,
    centreAd: false,
    mvt: true,
    segment: window.ftSegment_4171454 || '',
    segmentList: window.ftSegmentList_4171454 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp4171454 && window.ftImp4171454.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m4171454') && /^https:/.test(document.getElementById('ftscript_m4171454').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4171454'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_4171454'],
      ['ftcfid', 'ftConfID_4171454'],
      ['fttime', 'ftTimestamp_4171454'],
      ['ftsection', 'ftSection_4171454'],
      ['ftcustom', 'ftCustom_4171454'],
      ['ft_id', 'ftId_4171454'],
      ['ftimpid', 'ftImp4171454', 'impID'],
      ['gdpr', 'ftImp4171454', 'gdpr'],
      ['gdpr_consent', 'ftImp4171454', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp4171454', 'gdpr_pd'],
      ['us_privacy', 'ftImp4171454', 'us_privacy']
    ]
  };
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4171454").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4171454").style.display = "none";
		    }
		});
	}
}(ft4171454));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115738&l2=DV360&l3=4171454&l4=3985169&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115738&l2=DV360&l3=4171454&l4=3985169&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4171454;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4171454;
